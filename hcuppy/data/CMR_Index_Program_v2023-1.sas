...
/*                                                                */
/* Program:     CMR_Index_Program_v2023-1.SAS                     */
/*                                                                */
/* Diagnoses:   v2023-1 of the index is compatible v2023-1        */
...
/*                                                                */
/* Note:	    The SAS programs CMR_Format_Program_v2023-1 and   */
/*              CMR_Mapping_Program_v2023-1 must be run prior     */
...
/**********************************************/
LIBNAME  IN1     '\\Thuscasanapp49\lun0\Studies\CMIndexI10\data';                    * Location of input discharge data.   <===USER MUST MODIFY;
LIBNAME  OUT1    '\\thuscasanapp49\lun0\tools\icd-10-cm\2022\comorbidity_index\test\';                    * Location of output data.             <===USER MUST MODIFY;
...
/*********************************************/
/*  NUMBER OF COMORBIDITY VARIABLES, V2023.1 */
/*********************************************/ 
* Number of comorbidity variables in V2023.1.  
...
/*          SPECIFY FILE NAMES                */
/**********************************************/
* Input SAS file member name;                               %Let CORE = SID_2018_CORE_75pct;     *<===USER MUST MODIFY;            
* Output SAS file member name;                              %Let OUT  = SID_2018_CORE_75pct_v231;    *<===USER MUST MODIFY;
